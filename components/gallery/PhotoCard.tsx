    ...
    <div className="relative w-full h-full rounded-[16px] overflow-hidden group cursor-pointer bg-[#111]">
      {type === "image" ? (
        ...
        <>
          ...
          <button
            onClick={toggleMute}
            className="absolute top-3 right-3 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/60 text-white p-2 rounded-full backdrop-blur-sm"
          >
      ...
      {caption && (
        <div className="absolute bottom-0 left-0 right-0 z-10 p-4 translate-y-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-[400ms]">
          <p
