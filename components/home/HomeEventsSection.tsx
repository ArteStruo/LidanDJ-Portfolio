...
function parseEventDate(event: HomeEvent) {
  const fullDate = `${event.date} ${event.year}`;
      ...
      <div className="max-w-[1108px] mx-auto">
        <ScrollReveal className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 pb-6 border-b border-[rgba(255,255,255,0.1)] mb-8 sm:mb-10">
          <div>
            ...
            >
              Catch DJ Lidan live across Sri Lanka&apos;s underground progressive
              and electronic music circuit.
            </p>
          </div>
                ...
                <div className="flex items-start sm:items-center gap-4 sm:gap-6 lg:gap-10 min-w-0 w-full">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                      <h3
                        className="text-[15px] sm:text-[17px] text-white break-words"
                        style={{
                          fontFamily: "var(--font-space)",
                          fontWeight: 600,
                        }}
                    ...
                    <div className="flex items-center gap-1.5 mt-1">
                      ...
                      >
                        <path
                          d="M8 1.333C5.42 1.333 3.333 3.42 3.333 6c0 3.5 4.667 8.667 4.667 8.667S12.667 9.5 12.667 6C12.667 3.42 10.58 1.333 8 1.333Z"
                          stroke="#99A1AF"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          strokeWidth="1.33333"
                        />
                        <path
                          d="M8 7.333A1.333 1.333 0 1 0 8 4.667a1.333 1.333 0 0 0 0 2.666Z"
                          stroke="#99A1AF"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          strokeWidth="1.33333"
